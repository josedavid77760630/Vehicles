...
namespace Vehicles.API.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> AddVehicle(string id)
        {
            ...
            {
                Brands = _combosHelper.GetComboBrads(),
                UserId = user.Id,
        ...
        public async Task<IActionResult> AddVehicle(VehicleViewModel vehicleViewModel)
        {
            ...
            catch (DbUpdateException ex)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Ya esiste un vehiculo con esta placa.");
                }
                else
                {
            ...
            vehicleViewModel.Brands = _combosHelper.GetComboBrads();
